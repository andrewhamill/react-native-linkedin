...
export default class LinkedInModal extends React.Component {
    constructor() {
        ...
        this.renderWebview = () => {
            ...
            return (React.createElement(WebView, { source: { uri: this.getAuthorizationUrl() }, onNavigationStateChange: this.onNavigationStateChange, javaScriptEnabled: true, domStorageEnabled: true, injectedJavaScript: injectedJavaScript, sharedCookiesEnabled: true, incognito: true }));
        };
    }
